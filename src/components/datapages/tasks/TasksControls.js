...
export const TasksControls = ({ viewType, setViewType }) => {
			...
			{downSm && (
				<Grid container justify="center">
					<Grid item xs={12} className={classes.gridItem}>
						...
						>
							{t(`tasksModule.${collapsed ? "hide" : "show"}Filters`)}
						</Button>
					</Grid>
				</Grid>
			)}
							...
							<ButtonGroup className={classes.typeGroup}>
								<Button
									className={clsx(
										classes.modeBtn,
										classes.listBtn,
										viewType === "list" ? classes.modeBtnActive : null
									)}
								...
								<Button
									className={clsx(
										classes.modeBtn,
										classes.blocksBtn,
										viewType === "blocks" ? classes.modeBtnActive : null
									)}
